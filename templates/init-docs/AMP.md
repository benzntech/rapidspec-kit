...
**Q: Can I use AMP with existing projects?**
A: Yes, run `rapidspec constitution` to initialize RapidSpec in any existing project.

## Learn More

- **RapidSpec GitHub**: https://github.com/rapidspec/rapidspec
- **AMP Documentation**: https://ampcode.com/docs
- **Community Examples**: https://github.com/rapidspec/examples
