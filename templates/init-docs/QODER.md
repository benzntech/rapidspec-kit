# QODer CLI - RapidSpec Quick Start

This project was initialized with **QODer CLI** on [TIMESTAMP].
...
- Workflow: `AGENTS.md`
- QODer: [qoder.com/cli](https://qoder.com/cli)
- RapidSpec: [github.com/benzntech/rapidspec-kit](https://github.com/benzntech/rapidspec-kit)

---

*Generated for QODer CLI on [TIMESTAMP] by RapidSpec Init*
