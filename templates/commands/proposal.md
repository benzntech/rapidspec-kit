...
<critical_requirement>
MUST run `rapidspec proposal <change-id>` CLI command first to scaffold templates.
...
Use rapidspec show to verify generated files are correct.
</thinking>
...
```
User: "/rapidspec.proposal Smart Links duplicate prevention"
...
```
User: "/rapidspec.proposal fix 409 token refresh error"
