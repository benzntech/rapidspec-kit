...
Move to timestamped archive, validate strictly.
</command_purpose>
...
```
User: "/rapidspec.archive prevent-duplicate-smartlinks"
...
Validating...
Running: rapidspec validate --strict
✓ No errors found
...
```
User: "/rapidspec.archive add-auth-mutex"
...
```
User: "/rapidspec.archive add-feature"
